...
namespace Overdose\Laybuy\Model\Cron;
...
class CheckOrderStatus
{
     ...
     * @param \Overdose\Laybuy\Model\LaybuyFactory $laybuyFactory
    ...
    public function __construct(
        ...
        \Overdose\Laybuy\Model\LaybuyFactory $laybuyFactory,
    ...
    {
        if ($this->laybuy->getConfigPaymentAction() == \Overdose\Laybuy\Model\Laybuy::ACTION_AUTHORIZE_CAPTURE) {
            return;
        }
        ...
        foreach ($orders as $order) {
            if ($order->getPayment()->getMethod() == \Overdose\Laybuy\Model\Config::CODE && !$order->hasInvoices()) {
